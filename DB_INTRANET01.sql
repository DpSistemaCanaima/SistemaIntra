...
-- Volcando estructura para tabla Intranet.area
...
-- Volcando datos para la tabla Intranet.area: ~13 rows (aproximadamente)
DELETE FROM `area`;
...
-- Volcando estructura para tabla Intranet.gender
...
-- Volcando datos para la tabla Intranet.gender: ~3 rows (aproximadamente)
DELETE FROM `gender`;
...
-- Volcando estructura para tabla Intranet.grado
...
-- Volcando datos para la tabla Intranet.grado: ~4 rows (aproximadamente)
DELETE FROM `grado`;
...
-- Volcando datos para la tabla Intranet.imagenes: ~6 rows (aproximadamente)
...
-- Volcando estructura para tabla Intranet.level
...
-- Volcando datos para la tabla Intranet.level: ~4 rows (aproximadamente)
DELETE FROM `level`;
...
-- Volcando estructura para tabla Intranet.login
...
-- Volcando datos para la tabla Intranet.login: ~2 rows (aproximadamente)
DELETE FROM `login`;
INSERT INTO `login` (`TIPO`, `TIPO_USUARIOS`) VALUES
	(1, 'habilitado'),
	(2, 'deshabilitado');

-- Volcando estructura para tabla Intranet.nacionalida
DROP TABLE IF EXISTS `nacionalida`;
CREATE TABLE IF NOT EXISTS `nacionalida` (
  `ID_NACIONALIDA` int NOT NULL AUTO_INCREMENT,
  `nacionalidad` varchar(11) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  PRIMARY KEY (`ID_NACIONALIDA`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_spanish_ci;

-- Volcando datos para la tabla Intranet.nacionalida: ~2 rows (aproximadamente)
DELETE FROM `nacionalida`;
INSERT INTO `nacionalida` (`ID_NACIONALIDA`, `nacionalidad`) VALUES
	(1, 'Venezolano'),
	(2, 'Extranjero');

-- Volcando estructura para tabla Intranet.report
DROP TABLE IF EXISTS `report`;
CREATE TABLE IF NOT EXISTS `report` (
  `ID_REPORT` tinyint NOT NULL AUTO_INCREMENT,
  ...
  KEY `area` (`area`),
  CONSTRAINT `report_ibfk_1` FOREIGN KEY (`ID_NAME`) REFERENCES `user_datos` (`IDDATOS`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `report_ibfk_2` FOREIGN KEY (`ID_LEVEL`) REFERENCES `level` (`ID_LEVEL`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `report_ibfk_3` FOREIGN KEY (`STATUS`) REFERENCES `status` (`ID_STATUS`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `report_ibfk_4` FOREIGN KEY (`area`) REFERENCES `area` (`ID_AREA`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb3;

-- Volcando datos para la tabla Intranet.report: ~7 rows (aproximadamente)
DELETE FROM `report`;
...
-- Volcando estructura para tabla Intranet.rols
DROP TABLE IF EXISTS `rols`;
CREATE TABLE IF NOT EXISTS `rols` (
  `IDROLS` int NOT NULL AUTO_INCREMENT,
  `PRIVILEGE` text NOT NULL,
  PRIMARY KEY (`IDROLS`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb3;

-- Volcando datos para la tabla Intranet.rols: ~4 rows (aproximadamente)
DELETE FROM `rols`;
...
-- Volcando estructura para tabla Intranet.status
...
-- Volcando datos para la tabla Intranet.status: ~3 rows (aproximadamente)
DELETE FROM `status`;
...
-- Volcando estructura para tabla Intranet.user_datos
DROP TABLE IF EXISTS `user_datos`;
CREATE TABLE IF NOT EXISTS `user_datos` (
  ...
  PRIMARY KEY (`IDDATOS`),
  KEY `NAME` (`NAME`(1024)),
  KEY `ASSIGNED_AREA` (`ASSIGNED_AREA`),
  KEY `ID-ROLS` (`IDROLS`) USING BTREE,
  KEY `LOGIN` (`LOGIN`),
  KEY `GENDER` (`GENDER`),
  KEY `NACIONALIDAD` (`NACIONALIDAD`),
  KEY `CEDULA` (`CEDULA`),
  CONSTRAINT `IDROLS` FOREIGN KEY (`IDROLS`) REFERENCES `rols` (`IDROLS`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `LOGIN` FOREIGN KEY (`LOGIN`) REFERENCES `login` (`TIPO`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `user_datos_ibfk_1` FOREIGN KEY (`GENDER`) REFERENCES `gender` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `user_datos_ibfk_2` FOREIGN KEY (`NACIONALIDAD`) REFERENCES `nacionalida` (`ID_NACIONALIDA`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=158 DEFAULT CHARSET=utf8mb3;

-- Volcando datos para la tabla Intranet.user_datos: ~148 rows (aproximadamente)
DELETE FROM `user_datos`;
