...
--
-- Servidor: localhost
-- Tiempo de generación: 12-08-2024 a las 03:07:01
...
INSERT INTO `archivos_pdf` (`id`, `archivo`, `descripcion`, `fecha_subida`) VALUES
(1, 'ARC NAVARRO MORENO LUIS MANUEL.pdf', 'Declaración de Impuesto Sobre la Renta.', '2024-08-11 14:25:07');
...
(19, 'image.png', 'Isabel Piña Sierralta: Semilleros Científicos', 'El programa nacional Semilleros Científicos es una piedra fundamental para fomentar las vocaciones tempranas hacia las ciencias, de allí que se esté aplicando en una serie de estrategias para lograr el éxito de este.\n\nLa presidenta de Industria Canaima,C.A., Isabel Piña Sierralta, así lo destacó en su reciente visita a Mérida, a propósito de la discusión sobre la T2 que se llevó a cabo en la capital de este estado, con la participación de cientos de merideños y merideñas.\n\nRecordó que la línea 1 del Plan Nacional de Ciencia y Tecnología señala que se debe preservar y fomentar el talento humano calificado para la ciencia, la tecnología y la innovación; de allí que el Ministerio del Poder Popular para Ciencia y Tecnología (Mincyt) cuente, dentro de sus estrategias, con la Ruta Científica.'),
(21, 'plan.jpg', 'Plan vacacional', 'Los hijos e hijas del equipo de trabajo de Industria Canaima, C.A, ente adscrito al Ministerio para Ciencia y Tecnología (Mincyt), visitaron el Museo de Ciencias de Caracas, dónde conocieron más de cerca sobre la historia de Venezuela, la biodiversidad biológica y el mundo.\n\nDurante la visita, los 20 niños y niñas disfrutaron de espacios y exhibiciones, como las salas de “Color”, donde participaron activamente.\n\nEl recorrido guiado, también comprendió un paseo por las 10 salas expositivas y tres nichos, entre ellos: el salón donde se encuentran las estaciones del Tachiraptor, el oso Kodiak y la Jirafa; igualmente las salas de Electromagnetismo, Habla la Tierra y Tiempos de Pandemia Sala Interactiva.\n\nAsimismo, se deleitaron con las exposiciones: «El petróleo en nuestras vidas» y «Química para la Vida», donde aprendieron sobre la historia petrolífera de Venezuela y su importancia en la cotidianidad y la magia de la química, así como sus procesos y maravillas.\n\nEl Museo de Ciencias mantiene sus puertas abiertas de jueves a domingo, desde las 10:00 de la mañana hasta las 4:00 de la tarde, tras la reestructuración realizada por Gobierno Nacional a través del Mincyt y sus entes adscritos, el Fondo Nacional de Ciencia y Tecnología (Fonacit) y la Corporación para el Desarrollo Científico y Tecnológico (Codecyt).'),
...
(35, 'robotica_2.jpg', ' formacion especializada en robotica educativa', 'Industria Canaima, C.A. abre sus puertas para la formación especializada en Robótica Educativa\r\nVenezuela apuesta por la robótica educativa para potenciar vocaciones tempranas de niños, niñas y jóvenes\r\nIsabel Piña Sierralta: Semilleros Científicos son la piedra fundamental para fomentar las vocaciones tempranas hacia las ciencias\r\nHijos e hijas de trabajadores de Industria Canaima se divierten y aprenden en el Museo de Ciencias\r\nIndustria Canaima: Herramientas informáticas hechas con amor para el pueblo venezolano'),
(37, 'trabaja.jpg', 'Herramientas informáticas hechas con amor para el pueblo venezolano', 'ndustria Canaima es una empresa socialista encargada de la fabricación y comercialización de equipos de informática y de telecomunicaciones, cuyos procesos se basan en la sustentabilidad productiva para cubrir las necesidades de la nación en materia tecnológica.\r\n\r\nPor varios años, Industrias Canaima ha brindado su apoyo a los estudiantes venezolanos garantizando la posibilidad de formarse y aprender a través de las tecnologías, con equipos de computación y tabletas que se entregan gratuitamente a niños, niñas y jóvenes, incentivando la educación como una prioridad para el desarrollo del país.\r\n\r\nEsta labor ha sido posible gracias al apoyo de profesionales y técnicos que laboran en la planta, ubicada en la Base Aérea Francisco de Miranda “La Carlota”, Caracas.');
...
CREATE TABLE `report` (
  ...
  `FECHA_SOLUTION` text DEFAULT NULL,
...
(1, 'No me enciende el equipo', ' Danyerbert jose Brito rangel ', 98, 8, '2024-02-29', NULL, NULL, 3, 1, NULL),
(2, 'Mi equipo no enciende', ' Danyerbert jose Brito rangel ', 157, 8, '2024-03-06', NULL, NULL, 1, 2, NULL),
...
(7, 'fallas a la hora de crear copia de seguridad en la carpeta compartida', ' Luis manuel Navarro Moreno ', 157, 3, '2024-04-24', NULL, NULL, 1, 4, NULL);
...
(2, 'Luis manuel', 1, '31158004', '04241871113', '2024-08-12', 'Navarro Moreno', 'antimano', '', '', '', 1, '31158004', '92350b1bd0ae6d444c5da5b86db89da6b1ffcca0', 'lm395746@mail.com', 2, 1, 'Asistente de informática III', NULL, '', '', '', '../images/Recursos-Humanos.jpg', ''),
(3, 'Melvin daniel', 1, '30512676', '', '2024-08-12', 'Añez berrio', '', '', '', '', 1, 'admin', '9afbd981bb2da1514e74fb95c00fc85ed9fcafa6', '', 1, 1, 'Asistente de informática III ', NULL, '', '', '', '../images/pexels-roberto-nickson-2478248.jpg', ''),
(4, 'Danyerbert jose', 1, '27047631', '', '2024-08-12', 'Brito rangel', '', '', '', '', 1, '27047631', '5b636adac1d67aa8fd1745a0f5ad63616138dcca', 'danyerbertbrito@gmail.com', 1, 1, 'Asistente de informática III', NULL, '', '', '', '../images/Canaima.png', ''),
...
--
ALTER TABLE `imagenes`
  MODIFY `cod_imagen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
...
--
ALTER TABLE `nacionalida`
  MODIFY `ID_NACIONALIDA` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `report`
--
ALTER TABLE `report`
  MODIFY `ID_REPORT` tinyint(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `rols`
--
ALTER TABLE `rols`
  MODIFY `IDROLS` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `user_datos`
  MODIFY `IDDATOS` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=158;
