...
-- Tiempo de generación: 24-04-2024 a las 14:19:47
-- Versión del servidor: 10.3.36-MariaDB-0+deb10u2
-- Versión de PHP: 7.3.31-1~deb10u2
...
CREATE TABLE `grado` (
  ...
  `grado` varchar(1000) COLLATE utf8_spanish_ci NOT NULL
...
CREATE TABLE `nacionalida` (
  ...
  `nacionalidad` varchar(11) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
(3, 'Computadora no enciende', ' Danyerbert jose Brito rangel ', 4, '8', '2024-03-15', NULL, NULL, 3, 3, NULL),
(4, 'falla con el internet\r\n', ' luis manuel navarro moreno ', 2, '11', '2024-03-18', NULL, NULL, 3, 3, NULL);
...
INSERT INTO `user_datos` (`IDDATOS`, `NAME`, `NACIONALIDAD`, `CEDULA`, `telefono`, `FECHA`, `SURNAME`, `DIRECCION`, `CIUDAD`, `MUNICIPIO`, `PARROQUIA`, `GENDER`, `USER`, `PASSWORD`, `EMAIL`, `IDROLS`, `LOGIN`, `ASSIGNED_AREA`, `PASSWORD_ID`, `NUMERO_DE_HIJOS`, `NOBRE_Y_APELLIDO`, `FECHA_DE_NACIMIENTO`, `foto`) VALUES
(1, 'Reinaldo', 1, '2658439', '', '2024-01-01', 'MORALES CERTAD', '', '', '', '', 1, '2658439', '46ad1784cf775c2dea5b7dc2b8f4f2537e6c5b62', '', 2, 1, 'jubilado', NULL, '', '', '', '../images/defect.jpg'),
(2, 'luis manuel', 1, '31158004', '04241871113', '2003-02-15', 'navarro moreno', '', '', '', '', 1, '31158004', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'lm395746@gmail.com', 1, 1, 'Asistente de informática III', NULL, '', '', '', '../images/426172534_370934185872426_3637245909500994817_n.jpg'),
...
--
ALTER TABLE `report`
  MODIFY `ID_REPORT` tinyint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `user_datos`
  MODIFY `IDDATOS` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=152;
