...
<html lang="en">
    ...
    <head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="https://www.uneti.edu.ve/campus/pluginfile.php/34/block_edash_partners/content/Canaima.png">
        ...
        <div class="wrapper">
                    ...
                    <div class="d-flex align-items-center gap-lg-2 gap-1">
                        ...
                        <div class="logo-topbar">
                            ...
                            <a href="index.html" class="logo-dark">
                                ...
                                <span class="logo-sm">
                                    <img src="https://www.uneti.edu.ve/campus/pluginfile.php/34/block_edash_partners/content/Canaima.png"  alt="small logo">
                                </span>
                            </a>
                        </div>
                    ...
                    <ul class="topbar-menu d-flex align-items-center gap-3">
                        ...
                        <li class="dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                ...
                                <span class="align-middle d-none d-lg-inline-block">English</span><img src="svg/bajo.svg " alt="">
                            </a>
                        ...
                        <li class="dropdown">
                            <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                <span class="account-user-avatar">
                                    <img src="assets/images/users/luis.jpg" alt="user-image" width="32" class="rounded-circle">
                                </span>
                            ...
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated profile-dropdown">
                                ...
                                <!-- item-->
                                <a href="Perfil_del_admin.php" class="dropdown-item">
            ...
            <div class="leftside-menu">
                ...
                <a href="index.html" class="logo logo-light">
                    <span class="logo-lg">
                        <img src="https://www.uneti.edu.ve/campus/pluginfile.php/34/block_edash_partners/content/Canaima.png" style="width: 230px; height:auto; color:black;" alt="logo">
                    </span>
                    <span class="logo-sm">
                        <img src="https://www.uneti.edu.ve/campus/pluginfile.php/34/block_edash_partners/content/Canaima.png"  alt="small logo">
                    </span>
                ...
                <div class="h-100" id="leftside-menu-container" data-simplebar>
                    ...
                    <ul class="side-nav">
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarCrm">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="solicitud_tecnico.php">Tecnico</a>
                                    </li>
                                    <li>
                                        <a href="solicitud_rrhh.php">Recursos Humanos</a>
                                    </li>
                        ...
                        <li class="side-nav-item">
                        <a href="gestion_admin.php" class="side-nav-link">
                                <img src="svg/person.svg" alt="">
                        ...
                        <li class="side-nav-item">
                        <a href="encargar_caso.php"class="side-nav-link">
                           
                                <img src="svg/pc.svg" alt="">
                                <span>Encargar casos de soporte</span>
                            </a>
 ...
 <br>
  ...
  <img src="images/salto.jpg" width="100%" height="200px" alt="">
              
 <center> <a class="btn btn-outline-primary" href="encargar_caso.php">Todos</a> <a class="btn btn-outline-primary" href="activo.php">activo</a> <a class="btn btn-outline-primary" href="espera.php">en espera</a> <a class="btn btn-outline-primary" href="cerrado.php">cerrados</a></center>
                    ...
                    <table id="example" class=" table-bordered " style="width:100%">
                        ...
                        <tbody>
                            ...
                            INNER JOIN level AS l ON r.ID_LEVEL = l.ID_LEVEL WHERE r.STATUS = '2'";  
