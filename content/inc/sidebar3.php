      ...
      $sql1 = "SELECT IDDATOS FROM `user_datos` WHERE IDDATOS = $ID";
         ...
         ?>
                ...
                <a class="nav-link text-white " target="_blank" href="pdf/constancia_de_trabajo.php?edi=<?php echo $mostre['IDDATOS'];?>">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                    <img src="svg/constancia.svg" alt="">
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link text-white " target="_blank" href="./pdf/vacaciones.pdf">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                    <img src="svg/vacaciones.svg" alt="">
                    </div>
            ...
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">Gestion de usuarios
                </h6>
            </li>

            <li class="nav-item">
                <a class="nav-link text-white " " href="gestion_usuario.php">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                    <img src="svg/users.svg" alt="">
                    </div>
                    <span class="nav-link-text ms-1">Usuarios
                    </span>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link text-white "  href="cargar.php">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <img src="svg/noticia.svg" alt="">
                    </div>
                    <span class="nav-link-text ms-1">Cargar Noticias
                    </span>
                </a>
            </li>
