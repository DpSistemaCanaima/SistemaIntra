                  ...
                  <span class="hide-menu">Constancia de trabajo</span>
                        ...
                        <li class="nav-small-cap">
                            ...
                            <span class="hide-menu" data-bs-toggle="collapse" href="#collapseExample3" role="button"
                                aria-expanded="false" aria-controls="collapseExample" aria-expanded="false">Gestión <i
                                    class="ti ti-caret-down"></i></span>
                        </li>
                ...
                <div class="notification bg-primary rounded-circle"></div>
                    ...
                    <div class="navbar-collapse justify-content-end px-0" id="navbarNav">
                        <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                            <p class="mt-3" style="text-align: center;"><?php echo $NAME ." ". $APE ?><br>Administrador
                            </p>
                                ...
                                <h5 class="card-title fw-semibold mb-4">Mi Perfil</h5>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" id="disabledTextInput" name="PASSWORD" required class="form-control"
