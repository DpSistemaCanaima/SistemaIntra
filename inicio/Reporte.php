...
<body data-home-page="Reportes.html" data-home-page-title="Reportes" class="u-body u-xl-mode" data-lang="es">
    <header class="u-clearfix u-gradient u-header u-sticky u-sticky-3a7f u-header" id="sec-bf5c">
                ...
                <div class="u-custom-menu u-nav-container">
                    <ul class="u-nav u-unstyled u-nav-1">
                        <li class="u-nav-item"><a
                                class="u-button-style u-nav-link u-text-active-black u-text-hover-custom-color-3"
                                href="../dashboard.php" style="padding: 2px 20px;">Principal</a>
                        </li>
                        <li class="u-nav-item"><a
                                class="u-button-style u-nav-link u-text-active-black u-text-hover-custom-color-3"
                                href="Reporte.php?logout=on" style="padding: 2px 20px 2px 20px;">Cerrar sesion</a>
                        </li>
                    </ul>
                </div>
                        ...
                        <div class="u-inner-container-layout u-sidenav-overflow">
                            ...
                            <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2">
                                <li class="u-nav-item"><a class="u-button-style u-nav-link"
                                        href="../dashboard.php">Principal</a>
                                </li>
                                <li class="u-nav-item"><a class="u-button-style u-nav-link"
                                        href="Reporte.php?logout=on">Cerrar sesion</a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <section class="u-clearfix u-section-1" id="sec-5137">
        <div class="u-container-style u-group u-image u-shape-rectangle u-image-1" data-image-width="985"
            data-image-height="462">
            <div class="u-container-layout u-container-layout-1">
                <h1 class="u-text u-text-default u-text-1"><?php echo $name; ?></h1>
                <h2 class="u-text u-text-default u-text-2">Activo:<?php echo $cantidad;?> En
                    espera:<?php echo $cantidad1;?></h2>
            </div>
        </div>
        <a href="List/list.php?hold=true"
            class="u-active-custom-color-2 u-border-2 u-border-black u-border-hover-black u-btn u-btn-round u-button-style u-radius-11 u-white u-btn-1"
            target="barra1">En espera</a>
        <a href="List/list.php?Active=true"
            class="u-active-custom-color-2 u-border-2 u-border-black u-border-hover-black u-btn u-btn-round u-button-style u-radius-11 u-white u-btn-2"
            target="barra1">Activo</a>
        <a href="List/list.php?All=true"
            class="u-active-custom-color-2 u-border-2 u-border-black u-border-hover-black u-btn u-btn-round u-button-style u-radius-11 u-white u-btn-3"
            target="barra1">Inicio</a>
        <a href="List/list.php?close=true"
            class="u-active-custom-color-2 u-border-2 u-border-black u-border-hover-black u-btn u-btn-round u-button-style u-radius-11 u-white u-btn-4"
            target="barra1">Cerrado</a>
        <div
            class="u-border-3 u-border-palette-5-light-1 u-container-style u-group u-shape-rectangle u-white u-group-2">
            <iframe name="barra1" class="u-container-layout u-container-layout-2" src="./List/list.php"></iframe>
        </div>
        <h3
            class="u-align-center-lg u-align-center-md u-align-center-sm u-align-center-xs u-hidden-xs u-text u-text-default u-text-3">
