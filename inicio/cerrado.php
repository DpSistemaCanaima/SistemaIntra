        ...
        <div id="wrapper">
            ...
            <div id="main">
                <div class="inner">
                    ...
                    <br>
                    <br>
                    <a class="btn btn-outline-primary" href="index.php">Todos</a> <a class="btn btn-outline-primary" href="activo.php">activo</a> <a class="btn btn-outline-primary" href="espera.php">en espera</a> <a class="btn btn-outline-primary" href="cerrado.php">cerrados</a>
