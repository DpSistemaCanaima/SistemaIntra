...
<?php
if(isset($_GET['Report']) && empty($_GET['Report']) && ($_GET['Report']==null)){
}else{
          $id = $_GET['Report'];
$Report = mysqli_query($conn, "SELECT report.ID_REPORT,report.TITLE,user_datos.NAME,user_datos.SURNAME,user_datos.USER,report.ID_NAME,report.DESCRIPTION,report.CREATION_DATE,report.DATE_FINAL,report.STATUS FROM report INNER JOIN user_datos ON(report.User_send=user_datos.IDDATOS) WHERE ID_REPORT='$id'");
...
<link rel="stylesheet" href="C.css" media="screen">
  ...
  <body data-home-page="Reportes.html" data-home-page-title="Reportes" class="u-body u-xl-mode" data-lang="es"><header class="u-clearfix u-gradient u-header u-sticky u-sticky-3a7f u-header" id="sec-bf5c"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-xl u-sheet-1">
    ...
    <section class="u-clearfix u-section-1" id="sec-5137">
      ...
      <a href="List/list.php?hold=true" class="u-active-custom-color-2 u-border-2 u-border-black u-border-hover-black u-btn u-btn-round u-button-style u-radius-11 u-white u-btn-1">En espera</a>
      <a href="List/list.php?Active=true" class="u-active-custom-color-2 u-border-2 u-border-black u-border-hover-black u-btn u-btn-round u-button-style u-radius-11 u-white u-btn-2">Activo</a>
      <a href="List/list.php?init=true" class="u-active-custom-color-2 u-border-2 u-border-black u-border-hover-black u-btn u-btn-round u-button-style u-radius-11 u-white u-btn-3">Inicio</a>
      <a href="List/list.php?close=true" class="u-active-custom-color-2 u-border-2 u-border-black u-border-hover-black u-btn u-btn-round u-button-style u-radius-11 u-white u-btn-4">Cerrado</a>
      ...
      <div class="u-form u-form-1">
        ...
        echo "Fecha de creación: Ninguno <br>Fecha. culminación: Ninguno <br>Usuario: Ninguno";
        } else {
        echo "Fecha de creación: ", $Report['CREATION_DATE'], "<br>Fecha. culminación: ", $Report['DATE_FINAL'], "<br>Departamento: ", "<br>Usuario: ",$Report['NAME']," ",$Report['SURNAME'],"(",$Report['USER'],")";} ?>
          </p>
          <div class="u-form-group u-form-select u-label-top u-form-group-3">
            <label for="select-ed2a" class="u-label">Tecnico</label>
            <div class="u-form-select-wrapper">
              <select id="select-ed2a" name="Tecnico" class="u-border-1 u-border-grey-30 u-input u-input-rectangle">
          ...
          <div class="u-form-group u-form-submit u-label-top">
            <a href="#" class="u-border-none u-btn u-btn-submit u-button-style u-custom-color-2 u-hover-palette-2-light-2 u-btn-5">Guardar<br>
            </a>
          ...
          <input type="hidden" name="formServices" value="1b10673f61d0ac1bbe91e9b14d43bd9f">
        </form>
      </div>
      ...
      <div class="u-border-3 u-border-palette-5-light-1 u-container-style u-group u-shape-rectangle u-white u-group-3">
        <div class="u-container-layout u-container-layout-3">
          <p class="u-text u-text-default u-text-7">Descripcion</p>
        </div>
      </div>
    ...
    <section class="u-align-center u-clearfix u-section-2" id="sec-ffc3">
