<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	...
	$foto = $valores['foto'];
	 ?>
                ...
                <form action="foto_tec.php" method="post" enctype="multipart/form-data">
                    ...
                    <button type="submit"  style="border-radius:10px"  class="btn btn-outline-info">Actualizar</button>
                </form>
