    ...
    <div id="wrapper">
        ...
        <div id="main">
            <div class="inner">
                ...
                <!-- Header -->
                <br>
                <a href="mostraredit.php?User=true"
                ...
                <div class="espacio-tabla">
					...
					?>
						...
						echo "N.Binario";
                                ...
                                <th><?php if($mostrar ['LOGIN']==1){ echo "<font color='green'>Habilitado</font>";}else{ echo "<font color='red'>Deshabilitado</font>";} ?>
                                </th>
                                ...
                                <td>
                                    ...
                                    <!------Editar------>
                                    <form><a href="mostraredit.php?Edit=<?php echo $mostrar['IDDATOS'];?>"
                                            style="border-bottom: none;">Editar </a><a
                                            href="mostraredit.php?Del=<?php echo $mostrar['IDDATOS'];?>"
                                            style="border-bottom: none; color: blue">Eliminar</a>
...
>>>>>>> 3077b33d158a20a848513292eaf2fbc7bbb6244b
