	 ...
	 if ($_SESSION['Users'][2]== 2){//Si el usuario esta habilitado o no
		header("location:index.php");
								...
								<!-- Main -->
									<div id="main">
										<div class="inner">
											...
											<!-- Header -->
												<br>
												<a href="registro_de_re.php?User=true" style="border-bottom: none; font-size:30px; display: block; position: absolute; left: 90%; top:0">+</a>
												<br>
				  ...
				  <tbody>
					...
					<tr>
					  ...
					  <td>
						...
						<!------Editar------>
						  <form><a href="registro_de_re.php?Edit=<?php echo $mostrar['IDDATOS'];?>" style="border-bottom: none;">Editar </a><a href="registro_de_re.php?Del=<?php echo $mostrar['IDDATOS'];?>"style="border-bottom: none; color: blue">Eliminar</a>
			...
			<?php if(isset($_GET['Error'])&&($_GET['Error']=='Campo')){
						...
						header("refresh:3;registro_de_re.php?Edit={$_GET['Edit']}");
									...
									<span class="opener">Biblioteca digital</span>
										...
										<li><a href="./pdf/103_Manual_Canaimit.pdf" target="_blank">Manual de canaima(.PDF)</a></li>
												<li><a href="./pdf/para_el_usuario.docx" target="_blank">Cuidado de la canaima(.DOCX)</a></li>
													...
													<li>
														<a href="registro_de_re.php">Gestor de usuario</a>	
													</li>
													<li><a href="https://mail.industriacanaima.gob.ve/">Correo</a></li>
													<li><a href="registro_de_re.php?logout=on"><font color="red">cerrar sesion</a></li>
												</ul>
											</nav>
										...
										<div class="inner">				
											<!-- Header -->
												...
												<?php if(isset($_GET['Error'])&& $_GET['Error']=="Campo"){
														...
														header('refresh:3; registro_de_re.php?User=true');
