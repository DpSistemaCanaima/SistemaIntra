...
<link rel="stylesheet" href="Solucion.css" media="screen">
  ...
  <body class="u-body u-xl-mode" data-lang="es">
    <section class="u-clearfix u-section-1" id="sec-4f84">
      ...
      <div class="u-form u-form-2">
        <form action="https://forms.nicepagesrv.com/Form/Process" class="u-clearfix u-form-spacing-21 u-form-vertical u-inner-form" method=post name="form" style="padding: 0px;">
