...
<div id="main">
    <div class="inner">
        ...
        <br>
        <br>
        <a class="btn btn-outline-primary" href="reporte.php">Reporte</a>  <a class="btn btn-outline-primary" href="historial.php">Historial</a>
        <table id="example" class=" table-bordered " style="width:100%">
            <thead class="thead">
                <tr>
                    ...
                    <th class="text" scope="col">Fecha de solucion</th>
            ...
            <tbody>
                ...
                $sql = "SELECT  r.ID_REPORT, r.TITLE, u.NAME, u.SURNAME , r.DESCRIPTION, r.CREATION_DATE, r.FECHA_SOLUTION, r.DATE_FINAL,  l.LEVEL FROM report AS r 
          ...
          while ($mostrar = mysqli_fetch_assoc($result)){
                 ?>
                            <tr>
                                ...
                                <th><?php echo $mostrar ['FECHA_SOLUTION'] ?></th>
                        </tr>
                    </div>
                </div>
    </div>
