        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <strong> Usuario:</strong><?php echo $mostrar['NAME']." ". $mostrar['SURNAME']; ?><br>
            ...
            <a href="intro.php?ID_REPORT=<?php echo $mostrar['ID_REPORT']; ?>" class="btn btn-outline-primary" >Cerrar</a>
