...
<html lang="en">
    ...
    <body>
      ...
      <form method="post" action="enviar_soporte.php" style="margin:100px 50px 100px 50px; width:350px; height:50px">
        <input name="user_send" class="form-control" values="<?php echo $NAME; ?>"
                                placeholder="Solicitud" type="hidden" />
            <input type="text"  name="TITLE" class="form-control" id="exampleFormControlInput1" placeholder="Solicitud" required><br>
            <input type="text"  class="form-control" name="DESCRIPTION" placeholder="Descripcion" required><br>
