...
<html lang="en">
                    ...
                    <ul class="topbar-menu d-flex align-items-center gap-3">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated profile-dropdown">
                                ...
                                <!-- item-->
                                <a href="Perfil_del_tecnico.php" class="dropdown-item">
            ...
            <div class="leftside-menu">
                ...
                <div class="h-100" id="leftside-menu-container" data-simplebar>
                    ...
                    <ul class="side-nav">
                        ...
                        <li class="side-nav-item">
                        <a href="encargarCaso/encargar_caso.php"class="side-nav-link">
 ...
 <img src="1.jpg" width="100%" height="210px">

<br>
<br>
 <center><a class="btn btn-outline-primary" href="reporte.php">Reporte</a> <a class="btn btn-outline-primary"
    href="historial.php">Historial</a></center>
...
while ($mostrar = mysqli_fetch_assoc($result)){
 ?>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal<?php echo $mostrar['ID_REPORT'];?>"><img
                                                src="svg/editar.svg " alt="Industrias Canaima"
                                                width="15" height="15"> Editar</a>
                                    </li>
                                    
                                    
                                    <li><a class="dropdown-item" href="historial.php"><img
                                                src="re.svg " alt="Industrias Canaima"
                                                width="15" height="15">Historial</a></li>


                                    <li><a class="dropdown-item" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal<?php echo $mostrar['ID_REPORT']; ?>"
                                            href="#"><img
                                                src="svg/ojo.svg" alt="Industrias Canaima"
                                                width="15" height="15">Ver mas</a></li>
                    ...
                    <?php  include 'gestion_esdit.php';  ?>
                </div>
               
            </div>
            <?php  include 'modal_vermas.php';  ?>
        </div>
