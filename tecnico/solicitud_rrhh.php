...
<html lang="en">
    ...
    <body>
                ...
                <div class="h-100" id="leftside-menu-container" data-simplebar>
                    ...
                    <ul class="side-nav">
                        ...
                        <li class="side-nav-item">
                            <a href="tecnico.php" class="side-nav-link">
        ...
        <center>
          <h1> Solicitud de Recursos Humanos</h1>  
      <form method="post" action="enviar_admin.php" style="margin:100px 50px 100px 50px; width:350px; height:50px">
      <input type="hidden" name="nombre" value="<?php echo $NAME; ?>" maxlength="100">
      <input type="hidden" name="apellido" value="<?php echo $APE; ?>" maxlength="100">
            <input type="text"  name="cedula" class="form-control" id="exampleFormControlInput1" placeholder="Cedula" required><br>
