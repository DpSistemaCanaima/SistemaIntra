    ...
    <div class="wrapper">
        ...
        <div class="leftside-menu">
            ...
            <a href="" class="logo logo-light">
                <span class="logo-lg">
                <img class="logoo" src="Canaima (1).png" >
                </span>
                <span class="logo-sm">
                    <img src="https://www.uneti.edu.ve/campus/pluginfile.php/34/block_edash_partners/content/Canaima.png"
                        alt="small logo">
                                                ...
                                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                                    ...
                                                    <form>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-md-8 col-lg-9">
                                                                <input name="fullName" type="text" class="form-control"
                                                                    id="fullName" value="<?php echo $NAME . " " . $APE  ?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-md-8 col-lg-9">
                                                                <input name="fullName" type="text" class="form-control"
                                                                    id="fullName" value="<?php echo $cedula ?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-md-8 col-lg-9">
                                                                <input name="company" type="text" class="form-control"
                                                                    id="company" value="<?php echo $USER ?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-md-8 col-lg-9">
                                                                <input name="country" type="text" class="form-control"
                                                                    id="Country" value="<?php echo $tele ?>">
                                                            </div>
                                                        </div>
                                                ...
                                                <form>
                                                    ...
                                                    <div class="row mb-3">
                                                        <label for="currentPassword"
                                                            class="col-md-4 col-lg-3 col-form-label">Contraceña Actual</label>
                                                        <div class="col-md-8 col-lg-9">
                                                    ...
                                                    <div class="row mb-3">
                                                        <label for="newPassword"
                                                            class="col-md-4 col-lg-3 col-form-label">Nueva contraceña</label>
                                                        <div class="col-md-8 col-lg-9">
                                                    ...
                                                    <div class="row mb-3">
                                                        <label for="renewPassword"
                                                            class="col-md-4 col-lg-3 col-form-label">Repetir Contraceña</label>
                                                        <div class="col-md-8 col-lg-9">
