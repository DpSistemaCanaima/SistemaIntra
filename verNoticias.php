...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
      <section class="py-3">
        <div class="row mb-4 mb-md-0">
            <div class="col-md-8 me-auto my-auto text-left">
                <h5>Presentamos todos los acontecimientos de Industria Canaima C.A</h5>
            </div>
        </div>
                    ...
                    <div class="card-body p-3">
                        <div class="d-flex mt-n2">
                            ...
                            <div class="ms-3 my-auto">
                                <h6 class="mb-0">Titulo de la Noticia</h6>
      ...
      <div class="d-flex mt-n2">
      <div class="avatar avatar-xl bg-gradient-dark border-radius-xl p-2 mt-n4">
      <img src="../assets/img/small-logos/logo-atlassian.svg" alt="atlassian_logo">
      </div>
      <div class="ms-3 my-auto">
